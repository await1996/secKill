...
public class CodeMsg {
    ...
    public static CodeMsg PASSWORD_ERROR = new CodeMsg(500211,"登录密码错误");
    //商品异常 5003XX
    ...
    public static CodeMsg MIAO_SHA_REPEATED = new CodeMsg(500501,"不能重复秒杀");
    public static CodeMsg MIAOSHA_FAIL = new CodeMsg(500502, "秒杀失败");

    public CodeMsg fillArgs(Object... args){
        int code = this.code;
        String message = String.format(this.msg,args);
        return new CodeMsg(code,message);//返回一个填充了args的CodeMsg
    }
